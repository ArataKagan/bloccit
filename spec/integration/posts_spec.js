...
describe("routes : posts", () => {
    ...
    //guest user context
    describe("guest user performing CRUD actions on Post", () => {
        beforeEach((done) => {
            request.get({
     ...
     describe("GET /topics/:topicId/posts/new", () => {
        ...
        it("should redirect to a topic page", (done) => {
  ...
  //end of guest user content

    // member user context
    describe(
        "member user performing CRUD actions on Post", () => {
        beforeEach((done) => {
            request.get({
                url: "http://localhost:3000/auth/fake",
                form: {
